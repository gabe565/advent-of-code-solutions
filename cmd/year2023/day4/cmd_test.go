...
func TestSolution(t *testing.T) {
	...
	tests := []struct {
		...
		{"example part 1", day.Part1Cmd(), args{example}, 13, require.NoError},
		{"example part 2", day.Part2Cmd(), args{example}, 30, require.NoError},
		{"input part 1", day.Part1Cmd(), args{input}, 22674, require.NoError},
		{"input part 2", day.Part2Cmd(), args{input}, 5747443, require.NoError},
	}
